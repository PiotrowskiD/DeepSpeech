...
def create_flags():
    ...
    tf.app.flags.DEFINE_integer ('checkpoint_secs',  60000,         'checkpoint saving interval in seconds')
    tf.app.flags.DEFINE_integer ('max_to_keep',      0,           'number of checkpoint files to keep - default value is 5')
